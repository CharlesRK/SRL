...
class RobotControlApp:
    ...
    def create_buttons(self):
        ...
        walk_square_button = Button(self.master, text="Walk Square", command=self.walk_square)
        walk_square_button.pack()
    ...
    def walk_square(self):
        # Walk in a square by combining forward, right, backward, and left movements
        for _ in range(4):
            self.move_forward()
            time.sleep(2)
            self.move_right()
